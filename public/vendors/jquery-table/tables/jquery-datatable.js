$(function () {
    ...
    $('.js-exportable').DataTable({
        ...
        "buttons": [
            ...
            { extend: 'print', text: 'Print selected', charset: 'utf-8', bom: true,init: function (api, node, config) { $(node).addClass(" btn btn-round btn-primary btn-info"); }, exportOptions: { modifier: { selected: true } } },
        ],
        "select":{
            style:'multi',
