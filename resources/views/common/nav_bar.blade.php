    ...
    <div class="container-fluid">
        ...
        <div class="navbar-brand">
            <a href="{{action('AdminController@index')}}">
                <i class="fa fa-coffee" alt="Mplify Logo" class="img-responsive logo"></i>
                <span class="name">MeeGu</span>
            </a>
        </div>
                ...
                <li>
                    <div id="navbar-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <a href="javascript:void(0);" class="dropdown-toggle icon-menu" data-toggle="dropdown">
                                    <img class="rounded-circle" src="{{url('assets/images/user-small.png')}}" width="30" alt="">
                                </a>
                                <div class="dropdown-menu animated flipInY user-profile">
                                    <div class="d-flex p-3 align-items-center">
                                        <div class="drop-left m-r-10">
                                            <img src="{{url('assets/images/user-small.png')}}" class="rounded" width="50" alt="">
                                        </div>
